...
const FaqSection = () => {
    ...
    return (
        <section className="spacing">
            <div className="grid grid-cols-12 place-items-center justify-between md:gap-10">

                <div className="col-span-12 lg:col-span-6">
                    <img src={faqImage} alt="" className="border-l-4  border-primary w-full" />
                </div>
                    ...
                    <div className="space-y-4">
                        ...
                        >
                            {items.map((item) => (
                                ...
                                >
                                    <AccordionTrigger className="text-[15px] text-white leading-6 hover:no-underline focus-visible:ring-0 bg-primary dark:bg-secondary px-3 rounded-none">
                                        {item.title}
                                    </AccordionTrigger>
