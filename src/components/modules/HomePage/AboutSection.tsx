        ...
        <section className="spacing">
            <div className="flex-center flex-col lg:flex-row justify-between">
                ...
                <div className="flex-1">
                    ...
                    <div className="flex-center justify-between border-b pb-8 mb-8">
                    ...
                    <div className="flex-center gap-20">
                        ...
                        <Button variant={"primary"} className="px-8 py-6">Know More</Button>
                        <div className="flex-center gap-2.5">
                            <div className="bg-primary rounded-full p-1 inline-flex">
                                <img
                            ...
                            <div>
                                <h3 className="text-[22px] text-primary font-bold font-yantramanav italic">Ronni.M</h3>
